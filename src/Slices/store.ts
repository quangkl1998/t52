...
const storeSlice = createSlice({
  ...
  extraReducers(builder) {
    ...
    builder.addCase(getDistrictWithProvince.pending, (state) => {
      state.isLoading = true;
    });
    builder.addCase(getDistrictWithProvince.fulfilled, (state, { payload }) => {
      state.isLoading = false;
      state.listDistrict = payload;
    });
    builder.addCase(getDistrictWithProvince.rejected, (state, { error }) => {
      state.isLoading = false;
      state.error = error.message;
    });
  },
