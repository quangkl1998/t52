          ...
          <Routes>
            ...
            >
              <Route path="" element={<AdminPage />}>
                ...
                <Route path="loanguide/add" element={<AddLoanguide />}></Route>
                <Route
                ...
                <Route path="menu/detail/:id" element={<MenuDetail />}></Route>
            ...
            <Route path="" element={<HomeTemplate />}>
              ...
              <Route path="/:menuslug" element={<HomeSlug />} />
              <Route path="/:menuslug/page/:subslug" element={<HomeSlug />} />
