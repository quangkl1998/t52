    ...
    <div>
      <div className="container mx-auto">
        <div className=" px-10 lg:px-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 bg-white rounded-lg">
            <div className="p-5 text-gray-500 ">
              <ul>
                <li>
                  <span className="text-red-600 font-bold ">Mục tiêu: </span>{" "}
                ...
                <li>
                  <span className="text-red-600 font-bold">Về tầm nhìn: </span>
                ...
                <li>
                  <span className="text-red-600 font-bold">Về sứ mệnh: </span>
