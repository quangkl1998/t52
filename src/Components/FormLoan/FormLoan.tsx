...
const FormLoan = () => {
  ...
  const onSubmit = (values: any) => {
    ...
    emailjs
      .send("service_uyfrx3a", "template_yleob6f", data, "6bxE6T77g2MSso4FN")
      .then(
        (result) => {
          Swal.fire({
    ...
    <div className="container mx-auto px-5 lg:px-16">
      <div className="bg-white shadow-lg rounded-lg overflow-hidden p-5 border">
        <div className="border-b pb-3">
          <h3 className="text-lg text-gray-600">NHẬP THÔNG TIN ĐĂNG KÝ VAY</h3>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div>
              ...
              <div className="pb-6">
                <label
                  ...
                  className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300"
                >
                  Bạn muốn vay bằng <span className="text-red-600">*</span>
                </label>
                <select
                  {...register("loanType")}
                  id="asset-filter"
          ...
          <span className="italic">
            <span className="text-red-600">*</span> Thông tin bắt buộc
          </span>
