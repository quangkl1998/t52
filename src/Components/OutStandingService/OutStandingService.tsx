...
const OutStandingService = () => {
                ...
                <div className="md:w-3/4 w-full m-auto p-8 border-b ">
                    <div className="grid lg:grid-cols-10 grid-cols-1">
                        ...
                        <div className=" lg:col-span-4 col-span-1 ">
                            <h2 className="font-bold text-xl text-amber-500 mt-2 text-left">
                            ...
                            <div>
                                <div className="flex items-center mb-4 ">
                                    ...
                                    <p className="md:text-xl text-left text-sm font-medium leading-5 mb-0 ml-4 ">
                                        Vay bằng đăng ký xe máy, không thế chấp
                                        xe, vừa có tiền vừa có xe đi
                                    </p>
                                </div>
                                <div className="flex items-center mb-4 ">
                                    <img
                        ...
                        <div className=" lg:col-span-4 col-span-1 ">
                            ...
                            <div>
                                <div className="flex items-center mb-4 ">
                                    ...
                                    <p className="md:text-xl text-left text-sm font-medium leading-5 mb-0 ml-4 ">
                                        Khoản vay lên đến 80 triệu, chỉ cần xe
                                        máy chính chủ
                                    </p>
                                </div>
                                <div className="flex items-center mb-4 ">
                        ...
                        <div className=" lg:col-span-4 col-span-1 ">
                            ...
                            <div>
                                <div className="flex items-center mb-4 ">
                                    ...
                                    <p className="md:text-xl text-left text-sm font-medium leading-5 mb-0 ml-4 ">
                                        Khoản vay lên đến 1 tỷ. Chỉ cần đăng ký
                                        xe ô tô
                                    </p>
                                </div>
                                <div className="flex items-center mb-4 ">
                        ...
                        <div className=" lg:col-span-4 col-span-1 ">
                            ...
                            <div>
                                <div className="flex items-center mb-4 ">
                                    ...
                                    <p className="md:text-xl text-left text-sm font-medium leading-5 mb-0 ml-4 ">
                                        Khoản vay lên đến 2 tỷ, chỉ cần xe ô tô
                                        chính chủ
                                    </p>
                                </div>
                                <div className="flex items-center mb-4 ">
                        ...
                        <div className=" lg:col-span-4 col-span-1 ">
                            ...
                            <div>
                                <div className="flex items-center mb-4 ">
                                    ...
                                    <p className="md:text-xl text-left text-sm font-medium leading-5 mb-0 ml-4 ">
                                        Ứng dụng hỗ trợ tài chính trực tuyến đầu
                                        tiên đối với sản phẩm cho vay bằng Đăng
                                        ký xe máy
                                    </p>
                                </div>
                                <div className="flex items-center mb-4 ">
                        ...
                        <div className=" lg:col-span-4 col-span-1">
                            ...
                            <div>
                                <div className="flex items-center mb-4 ">
                                    ...
                                    <p className="md:text-xl text-left text-sm font-medium leading-5 mb-0 ml-4 ">
                                        Cung cấp đa dạng các sản phẩm bảo hiểm
                                        bình dân, đáp ứng mọi nhu cầu bảo vệ tài
                                        sản, sức khỏe, con người cho mọi khách
                                        hàng
                                    </p>
                                </div>
                                <div className="flex items-center mb-4 ">
                                    ...
                                    <p className="md:text-xl text-left text-sm font-medium leading-5 mb-0 ml-4">
                                        Trung tâm hỗ trợ thủ tục bồi thường
                                        nhanh chóng 24/24
                                    </p>
                                </div>
                                <div className="flex items-center mb-4 ">
                                    ...
                                    <p className="md:text-xl text-left text-sm font-medium leading-5 mb-0 ml-4">
                                        Hướng dẫn hồ sơ, giải đáp sản phẩm tại
                                        tất cả cửa hàng F88 trên toàn quốc
                                    </p>
                                </div>
                                <div className="flex items-center mb-4 ">
                                    <img
    ...
    return (
        <div className="text-center pt-5 md:pt-10 bg-gray-100">
            <div>
                <h2 className=" text-amber-500 md:text-3xl font-bold text-2xl mb-3 md:leading-6">
                    Dịch vụ nổi bật
                </h2>
                <p className=" text-gray-500 font-medium leading-4 md:text-base text-sm py-">
                    Khám phá các sản phẩm vay và bảo hiểm sức khỏe đang được
                    nhiều khách hàng sử dụng tại F88
                </p>
